        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container">
                    <h4 class="text-center font-weight-bold"> pendaftaran siswa baru </h4>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tempat" class="form-control" id="tempat" placeholder="Tempat lahir">
                    </div>
                    <div class="form-group">
                        <label for="">Tanggal lahir</label>
                        <input type="tempat" class="form-control" id="tanggal" placeholder="Tanggal lahir">
                    </div>
                    <div class="form-group">
